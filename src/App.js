...
const App = () => {
    ...
    return (
        <ConfigProvider
            ...
            theme={{
                token: {
                    colorPrimary: user.isPreviewTheme
                        ? user?.previewTheme?.primary || CONFIG.BASE_COLOR
                        : user?.theme?.primary || CONFIG.BASE_COLOR,
                    fontFamily: "Nunito",
                },
            }}
        >
                ...
                {isAuth && !user.isVerified ? (
                    ...
                    <>
                        <Route path="/" element={<DefaultWrapper />}>
                            ...
                            />
                            <Route
                                path="tests/exam/:id/test"
                                element={withSuspense(<Test />)}
                            />
                            <Route
                                path="messanger/*"
                                element={withSuspense(<Messanger />)}
                            />
                            <Route
                                path="info/*"
                            ...
                            <Route
                                path="task/*"
                                element={withSuspense(<TasksTemplate />)}
                            />
                            {/* <Route
                                path="docs/*"
                        ...
                        <Route path="/" element={<EmptyWrapper />}>
                            ...
                            <Route
                                path="confirm"
                                element={withSuspense(<ConfirmCode />)}
                            />
                            <Route
                                path="404"
