            ...
            <Sidebar>
                ...
                {/* <div className={sidebar.sidebarFooter}>
                    <Button type="light" disabled to="/support">
                        ...
                        <span className={sidebar.sidebarFooterButtonText}>
                            Обратная связь
                        </span>
                    </Button>
                    ...
                    <div className={styles.sidebarFooterSocials}>
                        <a
                            href="https://vk.com/resezvk"
                            target="_blanc"
                            className={styles.sidebarFooterSocial}
                        >
                            <Vk />
                        </a>
                    </div>

                    <Link to="/docs/rules" className={styles.sidebarFooterLink}>
                        Правила проекта
                    </Link>
                    <Link
                        to="/docs/publicoffer"
